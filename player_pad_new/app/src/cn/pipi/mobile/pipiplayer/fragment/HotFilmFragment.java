...
public class HotFilmFragment extends BaseFragment implements OnItemClickListener, OnTouchListener {
	...
	private void getServerData(){
		SpecialAsync specialAsync=new SpecialAsync(getActivity(),1);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if(getActivity()!=null){
			MobclickAgent.onEvent(getActivity(), "Click_tuijian","大片");
		}
