...
//		sharedPreferences=context.getSharedPreferences(PipiPlayerConstant.SharedPreferences, 0);
...
//			mLastUpdateTime=sharedPreferences.getString(PipiPlayerConstant.FLASHTIME, null);
			if(mLastUpdateTime!=null)mLastUpdateTime="最近更新:"+"qiny";
