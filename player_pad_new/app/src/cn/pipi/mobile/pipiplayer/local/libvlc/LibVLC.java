...
public class LibVLC {
  ...
  //Enable Clone Screen
    private boolean mEnableCloneMode=false;
    ...
    public void init(Context context) throws LibVlcException {
        ...
        if (!mIsInitialized) {
            ...
            String osType = "apad";
								String DeviceUDID = AppConfig.deviceUUID; //from device UDID
								String DocDir = FileUtils.confDirPath;
								String confDir = FileUtils.confDirPath;
			nativeInitp2pInformation(DocDir,confDir,AppConfig.dver,osType,DeviceUDID);
    ...
    public void setEnableCloneScreen(boolean bEnable)
    {
    	mEnableCloneMode = bEnable;
    }
    
    public boolean getEnableCloneScreen()
    {
    	return mEnableCloneMode;
    }
