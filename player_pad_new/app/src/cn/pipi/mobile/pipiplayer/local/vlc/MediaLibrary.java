...
public class MediaLibrary {
    ...
    private class GetMediaItemsRunnable implements Runnable {
        ...
        public void run() {
            ...
            DownloadActivity.showProgressBar(mContext);
            ...
            try {
                ...
                for (File file : mediaToScan) {
                    ...
                    DownloadActivity.sendTextInfo(mContext, file.getName(), count,
                            mediaToScan.size());
                    count++;
                ...
                System.out.println("---测试扫描本地--");
                for ( Media test : mItemList) {
                ...
                DownloadActivity.clearTextInfo(mContext);
                DownloadActivity.hideProgressBar(mContext);
