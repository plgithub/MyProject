...
public class VideoGridFragment extends SherlockGridFragment implements ISortable {
    ...
    private VideoGridInterface videoGridInterface;
    ...
    public void onAttach(Activity activity) {
    	...
    	try {
			videoGridInterface = (VideoGridInterface) activity;
		} catch (ClassCastException e) {
			throw new ClassCastException(activity.toString() + " must implement VideoGridInterface");
		}
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        videoGridInterface.initViewData();
...
//        popupMenu.show();
    ...
    public void setInitViewData(int itemWidth, int itemHeight){
    ...
    public interface VideoGridInterface{
