 ...
 * Original file: D:\\SmartGit\\workspace\\MyProject\\player_pad_new\\app\\src\\cn\\pipi\\mobile\\pipiplayer\\local\\vlc\\IAudioService.aidl
 */
package cn.pipi.mobile.pipiplayer.local.vlc;
public interface IAudioService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements cn.pipi.mobile.pipiplayer.local.vlc.IAudioService
{
private static final java.lang.String DESCRIPTOR = "cn.pipi.mobile.pipiplayer.local.vlc.IAudioService";
...
/**
 * Cast an IBinder object into an cn.pipi.mobile.pipiplayer.local.vlc.IAudioService interface,
 * generating a proxy if needed.
 */
public static cn.pipi.mobile.pipiplayer.local.vlc.IAudioService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cn.pipi.mobile.pipiplayer.local.vlc.IAudioService))) {
return ((cn.pipi.mobile.pipiplayer.local.vlc.IAudioService)iin);
}
return new cn.pipi.mobile.pipiplayer.local.vlc.IAudioService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
cn.pipi.mobile.pipiplayer.local.vlc.IAudioServiceCallback _arg0;
_arg0 = cn.pipi.mobile.pipiplayer.local.vlc.IAudioServiceCallback.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements cn.pipi.mobile.pipiplayer.local.vlc.IAudioService
{
...
@Override public void addAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.IAudioServiceCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.IAudioServiceCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.IAudioServiceCallback cb) throws android.os.RemoteException;
public void removeAudioCallback(cn.pipi.mobile.pipiplayer.local.vlc.IAudioServiceCallback cb) throws android.os.RemoteException;
